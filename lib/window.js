...
module.exports = function Window (config, path, opts) {
  ...
  window.on('closed', function () {
    ...
    electron.ipcMain.removeListener('update-badge-count', updateBadgeCount)
  })

  electron.ipcMain.on('update-badge-count', updateBadgeCount);
  ...
  function updateBadgeCount(ev, count) {
