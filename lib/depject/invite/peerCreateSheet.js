...
exports.needs = nest({
  ...
  //'peerInvites.async.getNearbyPubs': 'first'
})
      ...
      return {
        content: h('div', {
          ...
          when(inviteCode,
            ...
            h('button', {
              'ev-click': () => {
                /*api.peerInvites.getNearbyPubs((err, code) => {
                  //code ="lelidklelidklelidklelidklelidklelidklelidklelidklelidklelidklelidklelidklelidklelidklelidklelidklelidklelidk"
                  if (err) {
                    creating.set(false)
                    showDialog({
                      type: 'error',
