...
exports.create = function (api) {
  ...
  return nest('message.html', {
    ...
    render: function (msg, opts) {
      ...
      if (self && c.publicWebHosting !== undefined) {
        if (c.publicWebHosting === true) {
          miniContent.push(i18n('allows public web hosting'))
        } else {
          miniContent.push(i18n('disallows public web hosting'))
        }
      }
  ...
  function isRenderable (msg) {
    ...
    const c = msg.value.content
    if (!c || (!c.description && !isBlobLink(c.image) && !c.name && c.publicWebHosting === undefined)) return
    return true
  }
}
