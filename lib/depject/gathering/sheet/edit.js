...
exports.create = function (api) {
  ...
  return nest('gathering.sheet.edit', function (id) {
    getCurrentValues(id, (err, msg) => {
      ...
      const participants = msg.value && msg.value.content && msg.value.content.recps
      ...
      api.sheet.display(close => {
        ...
        const imageUrl = computed(chosen.image, (id) => id && api.blob.sync.url(id))
